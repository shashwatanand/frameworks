...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("in.shashwatanand.jhipster.firstapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "in.shashwatanand.jhipster.firstapp.security.DomainUserDetailsService",
